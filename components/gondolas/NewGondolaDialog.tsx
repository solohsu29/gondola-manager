...
import { Calendar, Image, MapPin, Plus, Settings, Upload } from "lucide-react"
...
export function NewGondolaDialog() {
...
const {fetchGondolas} = useStore()
  // Utility to get badge color for status
function getStatusColor(status: GondolaStatus) {
  switch (status) {
    case 'deployed': return 'bg-green-100 text-green-800';
    case 'in-use': return 'bg-blue-100 text-blue-800';
    case 'under-inspection': return 'bg-yellow-100 text-yellow-800';
    case 'maintenance': return 'bg-orange-100 text-orange-800';
    case 'off-hired': return 'bg-gray-100 text-gray-800';
          ...
          <DialogHeader className="space-y-3 pb-4 cursor-pointer">
            <div className="flex items-center justify-between mt-3">
              <DialogTitle className="text-2xl font-bold text-gray-900 flex items-center gap-2">
                New Gondola {gondolaData.serialNumber}
              </DialogTitle>
